...
class PSO():
    def calculate (self, costFunc, x0, bounds, num_particles, maxiter, verbose=False):
...
PSO.calculate('calculate', func1, initial, bounds, num_particles=15, maxiter=30, verbose=True)
